---
name: terrace-planning-refresh
description: Initialize or refresh the repo-local .planning package from Terrace state.
---

# Terrace Planning Refresh

Run `terrace planning refresh`.
