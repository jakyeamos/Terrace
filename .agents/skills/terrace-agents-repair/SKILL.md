---
name: terrace-agents-repair
description: Repair missing repo-local Terrace agent assets without changing workflow state.
---

# Terrace Agents Repair

Run `terrace agents repair`.
