---
name: terrace-parallel-status
description: Inspect worker worktrees, committed changes, ownership, and SUMMARY.md readiness.
argument-hint: <phase-id|run-id>
---

# Terrace Parallel Status

Run `terrace parallel status $ARGUMENTS`.
